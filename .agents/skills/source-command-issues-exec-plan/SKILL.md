---
name: "source-command-issues-exec-plan"
description: "複数Issueの実行計画を策定（優先度・依存関係・スケジュール）"
---

# source-command-issues-exec-plan

Use this skill when the user asks to run the migrated source command `issues-exec-plan`.
