---
name: "source-command-pm-auto-issue2dev"
description: "Issueレビューから実装完了まで完全自動化（Issueレビュー→設計→設計レビュー→作業計画→TDD実装）"
---

# source-command-pm-auto-issue2dev

Use this skill when the user asks to run the migrated source command `pm-auto-issue2dev`.
