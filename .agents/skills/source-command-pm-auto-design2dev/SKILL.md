---
name: "source-command-pm-auto-design2dev"
description: "設計レビューから実装完了まで完全自動化（設計→設計レビュー→作業計画→TDD実装）"
---

# source-command-pm-auto-design2dev

Use this skill when the user asks to run the migrated source command `pm-auto-design2dev`.
