use anvil::agent::recovery::{
    ...
    empty_response_recovery_note, first_scaffold_shell_edit_note, install_loop_recovery_note,
    is_dependency_install_command, is_scaffold_command, is_workspace_reset_command,
    no_tool_recovery_note, repeated_bash_error, repeated_plan_exploration_error,
    repo_change_after_setup_note, repo_change_recovery_note, should_block_bash_command,
...
fn recovery_notes_are_non_empty() {
    ...
    assert!(first_scaffold_shell_edit_note("src/app/page.tsx").contains("static game shell"));
