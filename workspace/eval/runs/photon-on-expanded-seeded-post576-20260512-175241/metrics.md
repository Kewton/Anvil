...
| `verifier_source_distribution` | `{"e2e_scenario_grader": 61, "package_json_scripts": 3, "python_compile_fallback": 6, "recent_successful_bash": 2}` |
| `verifier_no_candidates_rate` | `0.4722` |
| `repo_context_seed_source` | `{"<empty>": 24, "docs_project": 12, "node_project": 6, "python_project": 30}` |
| `repo_context_no_candidates_rate` | `0.1667` |
