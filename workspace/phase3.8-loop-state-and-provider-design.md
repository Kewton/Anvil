...
- `OutputRootExists`
- `DeliverableWritten`
- `DeliverableStructureVerified`
- `CoreRequirementsVerified`
- `ReviewCompleted`
...
- `CoreRequirementsVerified`
  - browser runnable, requested output root, requested deliverable kind など task contract の中核要件を確認できた
