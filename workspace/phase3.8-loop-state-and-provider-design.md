...
- `CoreBehaviorVerified`
  - browser runnable, requested output root, requested deliverable kind, playable core loop など task contract の中核要件を確認できた
...
## 4. Message-Structured Prompt Layout
...
### 4.3 Working Transcript と Carryover Summary
...
### 4.4 Transcript Retention Policy
...
## 5. Evidence Delta と Repeat Recovery
...
### 5.2 Repeat Recovery と Fail-Safe
