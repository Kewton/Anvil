...
export default function App() {
  ...
  return (
    <main data-anvil-polish="v1" style={{ minHeight: "100vh", padding: 32, background: "#f7f8fb", color: "#172033", fontFamily: "Inter, system-ui, sans-serif" }}>
      <section style={{ maxWidth: 960, margin: "0 auto", display: "grid", gap: 20 }}>
        <header style={{ display: "flex", justifyContent: "space-between", gap: 16, alignItems: "end", borderBottom: "1px solid #d8deea", paddingBottom: 16 }}>
          <div>
            ...
            <h1 style={{ margin: 0, fontSize: 40 }}>売上シミュレーターアプリ</h1>
          </div>
