...
- [Large-task `/ultra-plan-run` initial evaluation](minimal-loop-large-ultra-plan-run-20260615.md):
  first six-case large-task slice for Next.js, FastAPI, and Rust development/modification.
